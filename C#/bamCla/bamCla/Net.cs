...
namespace SnakeClient
{
    ...
    public class StateObject
    {
        ...
        public Queue<byte> streamQueue = new Queue<byte>(1024);
    }
    ...
    public class AsynchronousClient
    {
        ...
        //private static Queue<string> receiveDataQue = new Queue<string>();
        ...
        private static void decodeMesseage(byte[] byteMessage, StateObject state)
        {
            ...
            switch (protocol)
            {
                ...
                case 'E': // End of Send
                    MainApp.clientHandler.Eos = true;
                    break;
        ...
        private static void DecodeDotData(string dotData)
        {
            ...
            //MainApp.clientHandler.DotPositions.Clear();
            MainApp.clientHandler.DotPositions = new List<Position>();
            ...
            for (int i = 0; i < dotNum; i++)
            {
                ...
                Position dotPos = new Position(Int32.Parse(dotXY[0]), Int32.Parse(dotXY[1]));
                MainApp.clientHandler.DotPositions.Add(dotPos);
            }
